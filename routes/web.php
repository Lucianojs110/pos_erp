...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('products/massiveUpdate', [ProductController::class, 'massiveUpdate']);


    Route::post('products/masiveUpdatePercent', [ProductController::class, 'massiveUpdatePercent'])->name('products.massiveUpdatePercent');


    Route::post('roducts/selectionUpdatet', [ProductController::class, 'selectionUpdate'])->name('products.selectionUpdate');
    ...
    Route::get('/afipInvoice/{id}', [SellController::class, 'afipInvoice']);
    Route::post('/requestCae', [SellController::class, 'requestCae'])->name('requestCae');
    ...
    Route::put('business-locations/{id}', [BusinessLocationController::class, 'updateTaxConfig'])->name('business_locations.update');
